					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{URL::to('/deliveryManlogout')}}"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="{{URL::to('/deliveryManOrders')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> My Deliverd Orders</span></a></li>
						<li><a href="{{URL::to('/deliveryManDeliverdOrders')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> My Pending Orders</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
